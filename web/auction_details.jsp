    ...
    <body style="overflow-y:scroll">
        ...
        <c:forEach var="row" items="${result.rows}">
            <div class="commodity">
                ...
                <p class="content"><input type="checkbox" name="num" value="c" id="3" width='100%'><label for="3">favorite</label></p>
                <p class="content"><c:out value="您的报价为 "/>
                <p class="content"><form action="auction_compare.jsp">    
                    <input class="usrpswd" type="text" name="price"  width=100% />   
                    <br>
