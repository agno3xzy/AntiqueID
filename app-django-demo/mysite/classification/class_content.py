            ...
            '马':
                {
                    ...
                    '艺术特征':
                        [
                            "",
                            "此马皆躯体健硕饱满, 骨肉停匀, 四肢轻捷, 姿态生动, 有的扬首啸天, 有的偏首静立, 有的俯首近地, 有的跳跃奔腾。",
                            "此马的造型遵循着圆一方一圆的构成法则, 强调了其圆圆的胸脯, 方方的腰, 圆圆的后臀, 再加上一个近乎长方形的头, 就更加强了其雄强的气势。三彩马的每一处体积和线条都经过提炼加工, 达到了炉火纯青的完美程度。从侧面看去, 仿佛是强烈的视觉符号, 充满了内在的生命张力。",
            ...
            '人':
                {
                    ...
                    '艺术特征':
                        [
                            ...
                            "继承了周、汉以来陶俑制作的写实传统，简明、明快、概括、凝练的风格以及忠实、健康、丰满、自由舒展的情调。",
            ...
            '器皿':
                {
                    '分类':
                            ...
                            '日用器皿：有盘、碗、 瓶、 壶、 杯、 盂、 砚、 枕、 灯、 他本、 风头壶等, 此外还有家具、 车马、 假山、楼阁亭树等多种。',
                    ...
                    '艺术特征':
                        [
                            ...
                            "表达了我国装饰艺术写实主义传统的艺术风格，在思想性和艺术性方面都开创了新的境界，大大丰富了陶瓷制品的装饰手段。",
                            "器表装饰匀器体造型、釉彩的运用紧密结合，强讽整体的完美性。",
                            "装饰纹样的运用不拘常法以器饰纹．显得洒脱自如，得心应手；",
                            "装饰题材上融合了外来文化：出现莲花纹、荷叶纹；东南亚、南亚的动物如大象。",
                            '从过去的古朴、浑浊，到现在的浑厚、饱满、端庄而丰腴，体现了海纳百川的气魄。',
    ...
    '釉色分析':
        {
            '综述':
                [
                    "唐三彩是一种生产于唐代(618一907年）的彩色低温铅釉。它用白色粘土作胎，用含铜、铁、钻、猛等元素的矿物作釉料的着色剂，井在釉里加入很多的炼铅熔渣和铅灰做助熔剂，经过约800度的高温烧制而成。釉面呈现深绿、浅绿、翠绿及蓝、黄、白、赫、褐等多种色彩，但以黄、绿、白三彩为主，后来釉色日渐丰富，但汉语中“三”也有“多”之意，因此三彩一名被沿用下来。",
                    "唐三彩以铅的氧化物作为助熔剂，目的是降低釉料的熔融温度，在窑里烧制时，各种着色金属氧化物熔化后向四方扩散和流动，各种颜色互相浸润，形成斑驳灿烂的彩色釉。除此之外，铅的另一个作用是增加釉面的光亮度，使色彩更加艳丽，更加富丽堂皇。",
                ],
            '釉色颜色分析':
                {
                    '有黄、绿、褐、蓝、黑等色， 而以黄、绿、白三种颜色为主调。其中，黄、褐、绿为釉色的基本组成。',
